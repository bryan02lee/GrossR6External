...
void Overlay::ESP() {
	...
	DWORD healthBarColor = D3DCOLOR_ARGB(255, 240, 96, 96); //redish
	DWORD nameColor = D3DCOLOR_ARGB(255, 250, 190, 253); //pinkish
	DWORD blackColor = D3DCOLOR_ARGB(255, 0, 0, 0); //black
